...
static const int64 MAX_MONEY = 131072 * COIN; // maximum of 131 072 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 64 / 16; // 64 blocks found a day. Priority cutoff is 1 SMC day / 16 bytes.
    }
